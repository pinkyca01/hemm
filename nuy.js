...
async function starts() {
	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         const fbisnis = {key: {remoteJid: "6283815956151-1624547970@g.us", fromMe: false, id: "9162AC5104E9483430793144F7351AC3"},"message": {"contextInfo": {"stanzaId": "3EB0E2EE49D2", "participant": "0@s.whatsapp.net", "quotedMessage": {"extendedTextMessage": {"matchedText": "https://wa.me/6283893169044", "description": "Akun Privat", "title": name, "previewType": "NONE", "jpegThumbnail": fs.readFileSync('pinky.jpg')}}}}}
...
「 *PINKY BOT* 」`
          nuy.sendMessage(from, allmenu, MessageType.text, {quoted: fbisnis, contextInfo: { forwardingScore: 99999, isForwarded: true}})
          break
          case 'grupmenu':
                if (isBanned) return fakeitem(mess.only.benned)
                if (!isUser) return fakeitem(mess.only.userB)
