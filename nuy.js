	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         const pushname = caa.key.fromMe ? nuy.user.name : conts.notify || conts.vname || conts.name || '-'
			...
			const katalog = (teks) => {
             res = nuy.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 29, "message": teks, "footerText": name, "thumbnail": fs.readFileSync('pinky.jpg'), "surface": 'CATALOG' }}, {quoted: ftrolii})
...
╰────────𖧹`
            ...
            case 'product':
               ...
               ppxie = {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync('pinky.jpg')},"title": `${name}`,"description": `${ucapnya}`,"currencyCode": "Rp","priceAmount1000": "1000","retailerId": ``,"productImageCount": 1},"businessOwnerJid": "6283818221226@s.whatsapp.net"}}
               xie = await nuy.prepareMessage(from, ppxie, product, {})
               buttonxie = [
