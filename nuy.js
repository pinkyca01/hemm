...
async function starts() {
	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         const fkatalog = (teks) => {
             res = nuy.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "•°Base: FxSx & FdlX°•", "thumbnail": fs.readFileSync('pinky.jpg'), "surface": 'CATALOG' }}, {quoted: ftrolii, contextInfo: {"forwardingScore":99999,"isForwarded":true},sendEphemeral: true}})
