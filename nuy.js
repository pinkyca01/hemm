...
// last
            ...
            case 'style':
               ...
               daftarimg = await getBuffer(ppimg)
					xie = await nuy.prepareMessage(from, daftarimg, image, {thumbnail: daftarimg})
					gbutsan = [
                 {buttonId: `${prefix}daftarmenu`, buttonText: {displayText: '𝐷𝐴𝐹𝑇𝐴𝑅 𝑀𝐸𝑁𝑈'}, type: 1},
            ...
            case 'creator':
               if (isBanned) return replyca(mess.only.benned)  
				   if (!isUser) return replyca(mess.only.userB)
               nuy.sendMessage(from, {displayName: "100 kontak", contacts: [{displayName: "Owner", vcard: "BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:Owner\nORG: Mau Minta Esce?;\nitem1.TEL;waid=+0:+0\nitem1.X-ABLabel:Ponsel\nEND:VCARD"}]}, MessageType.contact, {quoted: ftrolii, contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,sendEphemeral: true,"externalAdReply": {"title": `Hai ${pushname}\n${name}`,"body": ``,"previewType": "VIDEO","thumbnailUrl": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/c/994409919080"}}})
           ...
           case 'bcgcstik':
            ...
            case 'asupan':
               ...
               ucapnya = `Video Asupan Done`
               xie = await nuy.prepareMessage(from, asupan, video, {mimetype: 'video/mp4'})
               gbutsan = [
                 {buttonId: `${prefix}asupann`, buttonText: {displayText: 'VIDEO ASUPAN'}, type: 1}
               ]
               gbuttonan = {
                 videoMessage: xie.message.videoMessage,
                 contentText: `${ucapnya}`,
                 footerText: `Note :\nGunakan Bot Xie Dengan Bijak Jangan Spam!\n\n𝐴𝑢𝑡ℎ𝑜𝑟 𝐹𝑥𝑆𝑥`,
                 buttons: gbutsan,
                 headerType: 4
               }
               await nuy.sendMessage(from, gbuttonan, MessageType.buttonsMessage, {mimetype: 'video/mp4',caption: ucapnya,"contextInfo": {mentionedJid: [sender]}, quoted: ftrolii, contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,sendEphemeral: true,"externalAdReply": {"title": `Hai ${pushname}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/c/994409919080"}}})
             	break
            case 'asupann':
               nuy.updatePresence(from, Presence.composing)
               if (isBanned) return replyca(mess.only.benned)
               ...
               xie = await nuy.prepareMessage(from, asupan, video, {mimetype: 'video/mp4'})
               gbutsan = [
                 {buttonId: `${prefix}asupan`, buttonText: {displayText: 'VIDEO ASUPAN'}, type: 1}
               ]
               gbuttonan = {
                 videoMessage: xie.message.videoMessage,
                 contentText: `${ucapnya}`,
