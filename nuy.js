      ...
      if (budy.startsWith('>')){
        ...
        replyca(e)
            ...
            case 'help':
               ...
               menucaa = `Hallo Kak ${pushname}\nSenang Bertemu Dengan Anda\nAda Yang Bisa Saya Bantu?\nSilahkan Pilih Di Bawah`
               buttons = [{buttonId: `${prefix}menu2`,buttonText:{displayText: 'List Menu'},type:1},{buttonId:`${prefix}rules`,buttonText:{displayText:'Rules Bot'},type:1},{buttonId:`${prefix}info`,buttonText:{displayText:'Info Bot'},type:1}]
               buttonsMessage = {
               contentText: `${menucaa}`,
...
╰────────𖧹`
               ...
               nuy.sendMessage(from, buffer, image, {quoted: ftroli, caption: menuca, contextInfo: {"forwardingScore": 99999, isForwarded: true, sendEphemeral: true, "thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg", 'base64'), mentionedJid: [sender],"externalAdReply": {"title": `Hai Kak ${pushname}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/6283818221226"}}, quoted: ftroli})
               break
            case 'grupmenu':
            menuca = `
╭──𖧹「 *INFO BOT* 」
...
// makermenu
            ...
            case 'carvedwood':
               if (isBanned) return fakeitem(mess.only.benned)   
					if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fakeitem('Teksnya Mana Kak?')
               txt = args.join(" ")
...
// last
            ...
            case 'img':
               if (isBanned) return fakeitem(mess.only.benned)    
				   if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fakeitem(`Example: ${prefix + command} Bunga`)
               query = args.join(" ")
            ...
            case 'tupai':
               ...
               if (args.length == 0) return fakeitem(`Example: ${prefix + command} 0838xxxxxxxx`)
               nomor = args[0]
            ...
            case 'settinggrup':
            case 'setgc':
               mayca = nuy.prepareMessageFromContent(from, {
               "listMessage": {
               "title": "List Message",
               ...
               "sections": [
                 {
                 "title": `Halo ${pushname} Gunakan Bot Dengan Bijak Ya`,
                     "rows": [
                       {
                         "title": "Welcome On",
                       ...
                       {
                         "title": "Anti Badword On",
                         "rowId": `${prefix}antibadword on`
                       },
                       {
                         "title": "Anti Badword Off",
                         "rowId": `${prefix}antibadword off`
                       },
                       {
                         "title": "Mode Anime On",
                         "rowId": `${prefix}modeanime on`
                       },
                       {
                         "title": "Mode Anime Off",
                         "rowId": `${prefix}modeanime off`
                       }
                       ]
                 }
                 ]
               }}, {quoted : ftroli}) 
               nuy.relayWAMessage(mayca, {waitForAck: true})
               break
            case 'profile':
    				nuy.updatePresence(from, Presence.composing)
					if (!isUser) return replyca(mess.only.userB)
			   ...
			   case 'cekganteng':
				...
				case 'cekcantik':
				   ...
				   if (!isUser) return replyca(mess.only.userB)
					...
					if (args.length < 1) return fakeitem('Yg Mau dicek Siapa Kak??')
            ...
            case 'setdesc':
               ...
               break
				...
				case 'translate':
				   if (isBanned) return fakeitem(mess.only.benned)    
				   if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fakeitem(`Example: ${prefix + command} Lu Jelek`)
               kode_negara = args[0]
               args.shift()
               ini_txt = args.join(" ")
...
// premium user
            ...
            case 'play':
               if (!isPrem) return fakeitem(mess.only.premium)
				   if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return await fakeitem(`Example: ${prefix + command} melukis senja`)
               query = args.join(" ")
            ...
            case 'ytmp4':
               if (!isPrem) return fakeitem(mess.only.premium) 
				   if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fakeitem(`Example: ${prefix + command} https://www.youtube.com/`)
               ini_link = args[0]
