...
╰────────𖧹`
               ...
               break
            case 'rules':
               nuy.sendMessage(from, rules(name), MessageType.text, {quoted: ftroli, contextInfo: { forwardingScore: 99999, isForwarded: true},externalAdReply: {'title':''+name,'body':''+prefix,'previewType': 'NONE', 'thumbnailUrl':'', 'thumbnail':fs.readFileSync('pinky.jpg')}})
    	         break
            case 'return':
				case '>':
				   if (!isOwner) return fakeitem(mess.only.ownerB)
