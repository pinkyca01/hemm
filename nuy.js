...
async function starts() {
	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         const fbisnis = {"key": {"remoteJid": "6283815956151-1624547970@g.us", "fromMe": false, "id": "9162AC5104E9483430793144F7351AC3"}, "message": {"extendedTextMessage": {"text": "> caa", "previewType": "NONE", "contextInfo": {"stanzaId": "3EB0E2EE49D2", "participant": "6283893169044@s.whatsapp.net", "quotedMessage": {"extendedTextMessage": {"text": "Pinky", "matchedText": "https://wa.me/6283893169044", "description": "Akun Bisnis", "title": "return", "previewType": "NONE", "jpegThumbnail": fs.readFileSync('pinky.jpg'), "contextInfo": {"forwardingScore": 99999, "isForwarded": true }}}}}}, "messageTimestamp": "1628178896", "participant": "6283899137143@s.whatsapp.net", "ephemeralOutOfSync": false}
...
「 *PINKY BOT* 」`
          nuy.sendMessage(from, allmenu, MessageType.text, {quoted: fbisnis})
          break
          case 'grupmenu':
                if (isBanned) return fakeitem(mess.only.benned)
                if (!isUser) return fakeitem(mess.only.userB)
...
╰────────𖧹`
            ...
            case 'unmute':
               ...
               break
            case 'rules':
               nuy.sendMessage(from, rules(name), MessageType.text, {quoted: fbisnis, contextInfo: { forwardingScore: 99999, isForwarded: true}})
    	         break
            case 'return':
				case '>':
				   if (!isOwner) return fakeitem(mess.only.ownerB)
...
//akhir kreator
           ...
           case 'bcstik':
					...
					if (isMedia && !nuy.message.videoMessage || isQuotedSticker) {
					...
					nuy.sendMessage(_.jid, bc, sticker, {quoted: ftroli})
