     ...
     if (isGroup) {
      ...
      if (budy.startsWith('>')){
        ...
        reply(e)
            ...
            case 'pale':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/pale.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'berkali':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/berkali.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'sensei':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/sensei.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'gatelsa':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/gatelsa.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'berpalinghati':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/berpalinghati.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'bermainmusik':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/bermainmusik.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'jamet':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/jamet.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pembohong':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/pembohong.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pala':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/pala.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pam':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/pam.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'loplop':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/lop.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'totet':
               nuy.updatePresence(from, Presence.composing)
	         	const pinky = fs.readFileSync('./mp3/totet.mp3')
               nuy.sendMessage(from, pinky, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'sticker':
			   case 'stiker':
