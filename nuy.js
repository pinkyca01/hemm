...
╰────────𖧹`
            ...
            case 'location2':
               ...
               imgnya = await nuy.prepareMessage(from, gaxie, location, {})
               gbutsan = [
                 {buttonId: `${prefix}daftarmenu`, buttonText: {displayText: '𝐷𝐴𝐹𝑇𝐴𝑅 𝑀𝐸𝑁𝑈'}, type: 1}
               ]
               gbuttonan = {
            ...
            case 'product':
               ...
               imgnya = await nuy.prepareMessage(from, {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync('pinky.jpg')},"title": `${name}`,"description": `${ucapnya}`,"currencyCode": "Rp","priceAmount1000": "1000","retailerId": ``,"productImageCount": 1},"businessOwnerJid": "6283818221226@s.whatsapp.net"}}, product, {})
               gbutsan = [
