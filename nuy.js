...
async function starts() {
	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         const fkatalog = (teks) => {
             nuy.sendMessage(from, teks, text, {quoted: ftrolii, { "orderMessage": { "itemCount": 321, "message": teks, "footerText": "•°Base: FxSx & FdlX°•", "thumbnail": fs.readFileSync('pinky.jpg'), "surface": 'CATALOG' }}, contextInfo: {"forwardingScore":99999,"isForwarded":true},sendEphemeral: true})
        }
