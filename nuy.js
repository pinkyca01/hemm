	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         const pushname = caa.key.fromMe ? nuy.user.name : conts.notify || conts.vname || conts.name || '-'
			...
			const katalog = (teks) => {
             res1 = nuy.prepareMessageFromContent(from,{"orderMessage": {"itemCount": 10, "message": teks, "footerText": "𝐴𝑢𝑡ℎ𝑜𝑟 𝐹𝑥𝑆𝑥", "thumbnail": fs.readFileSync('pinky.jpg'), "surface": 'CATALOG'}}, {quoted: ftrolii})
             nuy.relayWAMessage(res1)
         }
