...
async function starts() {
	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         const listmsgc = (from, title, desc, list) => {
    ...
    if (found === false) {
     ...
     if (isGroup) {
      ...
      if (messagesFaa.includes('pale')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/pale.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
		if (messagesFaa.includes('berkali')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/berkali.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
      if (messagesFaa.includes('sensei')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/sensei.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
      if (messagesFaa.includes('gatelsa')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/gatelsa.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
      if (messagesFaa.includes('berpalinghati')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/berpalinghati.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
      if (messagesFaa.includes('bermainmusik')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/bermainmusik.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
      if (messagesFaa.includes('jamet')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/jamet.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
      if (messagesFaa.includes('pembohong')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/pembohong.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
      if (messagesFaa.includes('pala')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/pala.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
      if (messagesFaa.includes('pam')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/pam.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
      if (messagesFaa.includes('loplop')) {
      nuy.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/lop.mp3')
      nuy.sendMessage(from, loli, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
      }
      if (messagesFaa.includes('totet')) {
      nuy.updatePresence(from, Presence.composing)
      ...
      if (budy.startsWith('>')){
        ...
        reply(e)
            ...
            case 'takes':
               ...
               nuy.sendMessage(from, ini_buff, sticker, { quoted: caa }).then(() => {
            ...
            case 'attp':
               if (isBanned) return fakeitem(mess.only.benned)   
				   if (!isUser) return fakeitem(mess.only.userB)
               if (args.length == 0) reply(`Contoh : ${prefix + command} Manca May`)
               ini_txt = args.join(" ")
               ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=${LolApi}&text=${ini_txt}`)
               await nuy.sendMessage(from, ini_buffer, sticker, {quoted: caa})
               break
// makermenu
            case 'darkneon':
            case 'candlemug':
...
// last
            ...
            case 'wallpaper':
               ...
               await nuy.sendMessage(from, buffer, image, {quoted: caa})
               break
				case 'triggered':
               if (isBanned) return fakeitem(mess.only.benned)   
				   if (!isUser) return fakeitem(mess.only.userB)
               ...
               ranp = getRandom('.gif')
               rano = getRandom('.webp')
               ini_buffer = `https://api.lolhuman.xyz/api/editor/triggered?apikey=${LolApi}&img=${ini_url}`
               exec(`wget "${ini_buffer}" -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
                  fs.unlinkSync(ranp)
                  buffer = fs.readFileSync(rano)
                  nuy.sendMessage(from, buffer, sticker, {quoted: caa}).then(() => {
                  fs.unlinkSync(rano)
                })
               })
               break
            case 'wasted':
               if (isBanned) return fakeitem(mess.only.benned)   
				   if (!isUser) return fakeitem(mess.only.userB)
               ini_url = args[0]
               buffer = await getBuffer(`https://api.lolhuman.xyz/api/editor/wasted?apikey=${LolApi}&img=${ini_url}`)
               await nuy.sendMessage(from, buffer, image, {quoted: caa})
               break
            case 'smoji':
               if (isBanned) return fakeitem(mess.only.benned)   
               ...
               ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji/${emoji}?apikey=${LolApi}`)
               await nuy.sendMessage(from, ini_buffer, sticker, {quoted: caa})
               break
            case 'gay':
               if (!isUser) return fakeitem(mess.only.userB)
