	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         caa.message = (Object.keys(caa.message)[0] === 'ephemeralMessage') ? caa.message.ephemeralMessage.message : caa.message
			...
			const { text, extendedText, contact, location, liveLocation, image, video, sticker, document, audio, product, button } = MessageType
			const date = new Date().toLocaleDateString()
			const time = moment.tz('Asia/Jakarta').format('HH:mm:ss')
			const jam = moment.tz('Asia/Jakarta').format('HH:mm')
         body = (type === 'conversation' && caa.message.conversation.startsWith(prefix)) ? caa.message.conversation : (type == 'imageMessage') && caa.message[type].caption.startsWith(prefix) ? caa.message[type].caption : (type == 'videoMessage') && caa.message[type].caption.startsWith(prefix) ? caa.message[type].caption : (type == 'extendedTextMessage') && caa.message[type].text.startsWith(prefix) ? caa.message[type].text : (type == 'listResponseMessage') && caa.message[type].singleSelectReply.selectedRowId ? caa.message[type].singleSelectReply.selectedRowId : (type == 'buttonsResponseMessage') && caa.message[type].selectedButtonId ? caa.message[type].selectedButtonId : (type == 'stickerMessage') && (getCmd(caa.message[type].fileSha256.toString('base64')) !== null && getCmd(caa.message[type].fileSha256.toString('base64')) !== undefined) ? getCmd(caa.message[type].fileSha256.toString('base64')) : ""
			...
			selectedButton = (type == 'buttonsResponseMessage') ? caa.message.buttonsResponseMessage.selectedButtonId : ''

         responseButton = (type == 'listResponseMessage') ? caa.message.listResponseMessage.title : ''
			...
			const replyca = (teks) => {
			    nuy.sendMessage(from, teks, text, {quoted: caa, contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,sendEphemeral: true,"externalAdReply": {"title": `Hai ${pushname}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/c/994409919080"}}})
			}
			const fakeitem = (teks) => {
             nuy.sendMessage(from, teks, text, {quoted: { key: { fromMe:false, participant:`0@s.whatsapp.net`, ...(from ? {remoteJid :"6283815956151-1604595598@g.us" }: {}) },message:{"orderMessage":{"orderId":"174238614569481","thumbnail": fs.readFileSync('pinky.jpg'),"itemCount":29,"status":"INQUIRY","surface":"CATALOG","message": name,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":99999,"isForwarded":true},sendEphemeral: true})
         }
         const fkatalog = (teks) => {
             nuyfaa = nuy.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "•°Base: FxSx & FdlX°•", "thumbnail": fs.readFileSync('pinky.jpg'), "surface": 'CATALOG' }}, {quoted: ftrolii, contextInfo: {"forwardingScore":99999,"isForwarded":true},sendEphemeral: true}})
             nuy.relayWAMessage(nuyfaa)
        }
         ...
         const ftroliii = {key: {fromMe:false, participant:`0@s.whatsapp.net`, ...(from ? {remoteJid :"6283815956151-1604595598@g.us" }: {}) },message:{"orderMessage":{"orderId":"174238614569481","itemCount":29,"status":"INQUIRY","surface":"CATALOG","message": name,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA==","jpegThumbnail": fs.readFileSync(`pinky.jpg`),"thumbnail": fs.readFileSync('pinky.jpg'),sendEphemeral: true}}}
         
         const listmsg = (from, title, desc, list, ftroli) => {
            let faa = nuy.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "List Menu","footerText": "Base: FxSx & FdlX","listType": "SINGLE_SELECT","sections": list}}, {quoted: ftroli})
            return nuy.relayWAMessage(faa, {waitForAck: true})
         }
         const listmsgc = (from, title, desc, list, ftroli) => {
            let faa = nuy.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "List Info","footerText": "Base: FxSx & FdlX","listType": "SINGLE_SELECT","sections": list}}, {quoted: ftroli})
            return nuy.relayWAMessage(faa, {waitForAck: true})
         }
     ...
     if (isGroup) {
				try {
					const getmemex = groupMembers.length
					    ...
					    fakeitem(`Maaf Pinky Tidak Bisa Masuk Ke Grup *${groupMetadata.subject}*\n\nMinimal Member Harus *${memberLimit}*`)
					setTimeout( () => {
                            nuy.groupLeave(from)
                            }, 100)
		setTimeout( () => {
		...
		setTimeout( () => {
		fakeitem(`Pinky Bot Akan Segera Keluar Dari Group *${groupMetadata.subject}*`)
		}, 0)
		}
      ...
      if (budy.startsWith('>')){
        ...
        replyca(e)
            ...
            case 'help':
               ...
               list = []
               listmenu = [`aboutmenu`,`grupmenu`,`funmenu`,`downloadmenu`,`mediamenu`,`audiomenu`,`makermenu`,`ownermenu`]
               listmenuu = [`Menu About`,`Menu Grup`,`Menu Fun`,`Menu Download`,`Menu Media`,`Menu Audio`,`Menu Maker`,`Menu Owner`]
               urutan = 1
               startnum = 0
               for (let x of listmenu) {
               const fxsx = {title: 'Menu Pinky Ada>' + urutan++,
                    rows: [
                       {
               ...
               listmsg(from, `${ucapanWaktu}`, `Hai ${pushname}\nSenang Bertemu Dengan Anda\nSilahkan Pilih Salah Satu Di Bawah`, list)
               break
            case 'aboutmenu':
            menuca = `
╭──𖧹「 *INFO BOT* 」
...
╰────────𖧹`
            ...
            case 'pale':
               ...
               nuy.sendMessage(from, pale, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'berkali':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const kali = fs.readFileSync('./mp3/berkali.mp3')
               nuy.sendMessage(from, kali, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'sensei':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const sei = fs.readFileSync('./mp3/sensei.mp3')
               nuy.sendMessage(from, sei, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'gatelsa':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const tel = fs.readFileSync('./mp3/gatelsa.mp3')
               nuy.sendMessage(from, tel, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'berpalinghati':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const hati = fs.readFileSync('./mp3/berpalinghati.mp3')
               nuy.sendMessage(from, hati, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'bermainmusik':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const moshik = fs.readFileSync('./mp3/bermainmusik.mp3')
               nuy.sendMessage(from, moshik, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'jamet':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const met = fs.readFileSync('./mp3/jamet.mp3')
               nuy.sendMessage(from, met, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pembohong':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const pem = fs.readFileSync('./mp3/pembohong.mp3')
               nuy.sendMessage(from, pem, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pala':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const pa = fs.readFileSync('./mp3/pala.mp3')
               nuy.sendMessage(from, pa, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pam':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const pam = fs.readFileSync('./mp3/pam.mp3')
               nuy.sendMessage(from, pam, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'loplop':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const lop = fs.readFileSync('./mp3/lop.mp3')
               nuy.sendMessage(from, lop, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'totet':
               if (isBanned) return fakeitem(mess.only.benned)
	         	const tet = fs.readFileSync('./mp3/totet.mp3')
               nuy.sendMessage(from, tet, MessageType.audio, {quoted: caa, mimetype: 'audio/mp4', ptt:true})
               break
            case 'sticker':
			   case 'stiker':
				case 'stick':
				   ...
				   if ((isMedia && !caa.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								fakeitem(`Gagal, pada saat mengkonversi ${tipe} ke stiker`)
							})
							.on('end', function () {
								console.log('Finish')
								exec(`webpmux -set exif ${addMetadata(namo, ator)} ${ran} -o ${ran}`, async (error) => {
				   	...
				   	if ((isMedia && !caa.message.videoMessage || isQuotedSticker) && args.length == 0) {
						...
						await removeBackgroundFromImageFile({path: media, apiKey: keyrmbg, size: 'auto', type: 'auto', ranp}).then(res => {
							...
							fs.writeFileSync(ranp, buffer, (err) => {
								if (err) return fakeitem('Gagal, Terjadi kesalahan, silahkan coba beberapa saat lagi')
							})
						...
						fakeitem(`reply sticker dengan caption ${prefix}colong`)
					}
					break
            case 'swm':
	         case 'stickerwm':
            ...
            case 'takes':
               ...
               if (args.length == 0) return fkatalog(`Example: ${prefix + command} Pinky/Bot`)
               const encmedia = isQuotedSticker ? JSON.parse(JSON.stringify(caa).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : caa
...
// makermenu
            ...
            case 'woodblock':
               if (isBanned) return fakeitem(mess.only.benned)   
					if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fkatalog('Teksnya Mana Kak?')
               txt = args.join(" ")
...
// Anime
            case 'anime':
               ...
               if (args.length == 0) return fkatalog(`Example: ${prefix + command} one piece`)
               query = args.join(" ")
...
// last
			   ...
			   case 'toimg':
			      if (isBanned) return fakeitem(mess.only.benned)    
				   ...
				   if (isLimit(sender)) return fakeitem(limitend(pushname))
					if (!isQuotedSticker) return fakeitem('Reply stickernya kak')
            ...
            case 'img':
               if (isBanned) return fakeitem(mess.only.benned)    
				   if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fkatalog(`Example: ${prefix + command} Bunga`)
               query = args.join(" ")
            ...
            case 'tupai':
               ...
               if (args.length == 0) return fkatalog(`Example: ${prefix + command} 0838xxxxxxxx`)
               nomor = args[0]
               ...
               daftarimg = await getBuffer(ppimg)
					nuy.sendMessage(from, daftarimg, image, {quoted: ftroli, contextInfo: { forwardingScore: 99999, isForwarded: true}, caption: captionnya})
					break
            case 'profile':
    				nuy.updatePresence(from, Presence.composing)
					if (!isUser) return replyca(mess.only.userB)
               ...
               if (!isUser) return replyca(mess.only.userB)
               list = []
               listmenu = [`totaluser`,`blocklist`,`banlist`,`chatlist`]
               listmenuu = [`List User`,`List Block`,`List Ban`,`List Chat`]
               urutan = 1
               startnum = 0
               for (let x of listmenu) {
               const fxsx = {title: 'Info Bot Ada>' + urutan++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
               ...
               listmsgc(from, `「 INFO BOT PINKY 」`, `${fx} Nama Bot : ${me.name}\n${fx} Owner Bot : Privat!\n${fx} Prefix : | ${prefix} |\n${fx} Total Block : ${blocked.length}\n${fx} Aktif Sejak : ${kyun(uptime)}\n${fx} Total User : ${user.length}`, list)
               break
				case 'totaluser':
					nuy.updatePresence(from, Presence.composing) 	
					if (!isUser) return replyca(mess.only.userB)
					...
					nuy.sendMessage(from, teks.trim(), extendedText, {quoted: ftroli, contextInfo: {"mentionedJid": user}})
					break
            case 'chatlist':
		      case 'cekchat':
		         if (isBanned) return fakeitem(mess.only.benned)  
				   if (!isUser) return replyca(mess.only.userB)
			    	...
			    	nuy.sendMessage(from, teks, MessageType.text, {quoted: ftroli})
		    		break
	    	   case 'blocklist':
					teks = 'List Block :\n'
			   ...
			   case 'banlist':
				   ben = '```List Banned``` :\n'
					...
					nuy.sendMessage(from, ben.trim(), extendedText, {quoted: ftroli, contextInfo: {"mentionedJid": ban}})
					break
				case 'ban':
					nuy.updatePresence(from, Presence.composing) 
				...
				case 'addprem':
					...
					premium = addpremium
					fakeitem(`*Berhasil Menambahkan ${premium} Ke database User Premium*`)
					break
				case 'removeprem':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					rprem = body.slice(13)
					premium.splice(`${rprem}@s.whatsapp.net`, 1)
					fakeitem(`Berhasil Remove wa.me/${rprem} Dari User Premium`)
					break
					case 'unban':
					if (!isOwner)return fakeitem(mess.only.ownerB)
					bnnd = body.slice(8)
					ban.splice(`${bnnd}@s.whatsapp.net`, 1)
					fakeitem(`Nomor wa.me/${bnnd} telah di unban!`)
					break
				case 'block':
				   nuy.updatePresence(from, Presence.composing) 
					if (!isOwner) return fakeitem(mess.only.ownerB)
					nuy.blockUser (`${body.slice(7)}@c.us`, "add")
					fakeitem(`perintah Diterima, memblokir ${body.slice(7)}@c.us`)
					break
				case 'unblock':
               if (isBanned) return fakeitem(mess.only.benned)    
				   if (!isUser) return replyca(mess.only.userB)
				   ...
				   nuy.blockUser (`${body.slice(9)}@c.us`, "remove")
					fakeitem(`perintah Diterima, membuka blokir ${body.slice(9)}@c.us`)
				   break 
				case 'readmore':
					if (isBanned) return fakeitem(mess.only.benned)    
					if (!isUser) return replyca(mess.only.userB)
					if (args.length < 1) return fkatalog('Textnya Mana?')
               ...
               if (limitCounts <= 0) return fakeitem(from,`Limit anda habis`, id)
            ...
            case 'fitnah':
               if (isBanned) return fakeitem(mess.only.benned)    
				   if (!isUser) return replyca(mess.only.userB)
				   if (args.length < 1) return fkatalog(`Usage :\n${prefix}fitnah [@tag/pesan/balasanbot]]\n\nEx : \n${prefix}fitnah @tagmember/hai/hai juga`)
				   var gh = body.slice(8)
				   mentioned = caa.message.extendedTextMessage.contextInfo.mentionedJid
			   ...
			   case 'cekganteng':
				...
				case 'cekcantik':
				   ...
				   if (!isUser) return replyca(mess.only.userB)
					...
					if (args.length < 1) return fkatalog('Yg Mau dicek Siapa Kak??')
               ...
               break
				case 'tts':
				   ...
				   if (isLimit(sender)) return replyca(limitend(pushname))
					...
					if (args.length < 2) return fkatalog('Textnya Mana?')
					dtt = body.slice(5)
					ranm = getRandom('.mp3')
					rano = getRandom('.ogg')
					dtt.length > 600
				...
				case 'translate':
				   if (isBanned) return fakeitem(mess.only.benned)    
				   if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fkatalog(`Example: ${prefix + command} Lu Jelek`)
               kode_negara = args[0]
               args.shift()
               ini_txt = args.join(" ")
            ...
            case 'report':
               if (isBanned) return fakeitem(mess.only.benned)    
               if (!isUser) return replyca(mess.only.userB)
               if (args.length < 1) return fkatalog(`Yang mau direport kak?`)
               const pesan = body.slice(8)
               if (pesan.length > 300) return reply('Maaf Teks Terlalu Panjang, Maksimal 300 Teks')
            ...
            case 'request':
               if (isBanned) return fakeitem(mess.only.benned)    
               if (!isUser) return replyca(mess.only.userB)
               if (args.length < 1) return fkatalog(`Mau request apa? Contoh: #request fitur anime`)
               const cfrr = body.slice(8)
               if (cfrr.length > 300) return fakeitem('Maaf Teks Terlalu Panjang, Maksimal 300 Teks')
               var nomor = caa.participant
               ...
               break
				...
				case 'hilih':
				   ...
				   if (isLimit(sender)) return fakeitem(limitend(pushname))
			   	fakeitem(mess.wait)
					if (args.length < 1) return fkatalog('Teksnya mana gan?')
            ...
            case 'resepmasakan':
			   ...
			   case 'hekerbucin':
				...
				case 'tiktokstalk':
					...
					if (!isUser) return replyca(mess.only.userB)
					if (isLimit(sender)) return fakeitem(limitend(pushname))
					if (args.length < 1) return fkatalog('Usernamenya mana gan?')
            ...
            case 'katacinta':	
			   ...
			   case 'gaypersen':
			   	if (!isUser) return replyca(mess.only.userB)
			   	if (isLimit(sender)) return fakeitem(limitend(pushname))
				   if (args.length < 1) return fkatalog('tag temanmu!')
		   		rate = body.slice(11)
			   ...
			   case 'pbucin':
    			...
    			case 'bucinpersen':
	   			if (!isUser) return replyca(mess.only.userB)
	    			if (isLimit(sender)) return fakeitem(limitend(pushname))
	   			if (args.length < 1) return fkatalog('Mana Nama?')
		   		rate = body.slice(8)
		      ...
		      case 'map':
               if (isBanned) return fakeitem(mess.only.benned)    
			   	if (!isUser) return replyca(mess.only.userB)
               if (args.length < 1) return fkatalog('Masukan nama daerah')
               daerah = body.slice(5)
               try {
			   ...
			   case 'kbbi':
			      ...
			      if (isLimit(sender)) return fakeitem(limitend(pushname))
			      fakeitem(mess.wait)
					if (args.length < 1) return fkatalog('Apa yang mau dicari gan?')
           ...
           case 'bcgcstik':
            ...
            case 'bcvn':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					if (!isQuotedAudio) return fakeitem('Reply audionya kak')
					anu = await nuy.chats.all()
            ...
            case 'bcvideo':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					if (!isQuotedVideo) return fakeitem('Reply videonya kak')
					anu = await nuy.chats.all()
            ...
            case 'bcgcvideo':
			   ...
			   case 'add':
				   ...
				   if (!isUser) return replyca(mess.only.userB)
					...
					if (!isGroupAdmins) return fakeitem(mess.only.admin)
					if (!isBotGroupAdmins) return fakeitem(mess.only.Badmin)
					if (args.length < 1) return fkatalog('Yang mau di add siapa??')
			   ...
			   case 'kick':
				...
				case 'd':
					...
					break
				case 'delow':
				   if (!isOwner) return fkatalog(mess.only.ownerB)
					nuy.deleteMessage(from, { id: caa.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
					break
			   case 'demote':
			      if (isBanned) return fakeitem(mess.only.benned)    
			   ...
			   case 'nsfw':
			      ...
			      if (!isUser) return replyca(mess.only.userB)
					if (!isGroup) return fakeitem(mess.only.group)
					if (!isGroupAdmins) return fakeitem(mess.only.admin)
					if (args.length < 1) return fkatalog('on untuk mengaktifkan, off untuk menonaktifkan')
					if ((args[0]) === 'on') {
            ...
            case 'addbadword':
               if (!isOwner) return fakeitem(mess.only.ownerB)
               if (args.length < 1) return fkatalog( `Kirim perintah ${prefix}addbadword [kata kasar]. contoh ${prefix}addbadword bego`)
            ...
            case 'delbadword':
               if (!isOwner) return fakeitem(mess.only.ownerB)
               if (args.length < 1) return fkatalog( `Kirim perintah ${prefix}delbadword [kata kasar]. contoh ${prefix}delbadword bego`)
               ...
               break
				case 'clone':
				   if (!isOwner) return fakeitem(mess.only.ownerB)
					if (!isGroup) return fakeitem(mess.only.group)
					if (!isGroupAdmins) return fakeitem(mess.only.admin)
					if (args.length < 1) return fkatalog('Tag target yang ingin di clone')
...
//setting bot
				...
				case 'setpref':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					prefix = args.join(" ")
					fakeitem(`Prefix Menjadi : ${prefix}`)
					break
				case 'setfx':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					fx = args.join(" ")
					fakeitem(`Hias Menjadi : ${fx}`)
					break
				case 'setlimit':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					limitt = args.join(" ")
					fakeitem(`Limit Menjadi : ${limitt}`)
					break 
				case 'setmemlimit':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					memberLimit = args.join(" ")
					fakeitem(`Limit Member Menjadi : ${memberLimit}`)
					break 
				case 'setwms':
					if (!isOwner) return fakeitem(mess.only.ownerB)
				   ...
				   fakeitem(`Wm Sticker Menjadi : ${namo} • ${ator}`)
					break 
				case 'setnamebot':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					name = args.join(" ")
					fakeitem(`Name Bot Menjadi : ${name}`)
					break
            case 'setlol':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					LolApi = args.join(" ")
					fakeitem(`Apikey Lolhuman Menjadi : ${LolApi}`)
					break
            case 'settech':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					TechApi = args.join(" ")
					fakeitem(`Apikey Tech Menjadi : ${TechApi}`)
					break
            case 'setzeks':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					ZeksApi = args.join(" ")
					fakeitem(`Apikey Zeks Menjadi : ${ZeksApi}`)
					break
            case 'setthumb':
            case 'setffoto':
		         if (!isOwner) return fakeitem(mess.only.ownerB)
            ...
            case 'scmd':
               if (!isOwner) return fakeitem(mess.only.ownerB)
               if (isQuotedSticker) {
               if (!jri) return fakeitem(`Penggunaan : ${prefix}${command} cmdnya dan tag stickernya`)
               var kodenya = caa.message.extendedTextMessage.contextInfo.quotedMessage.stickerMessage.fileSha256.toString('base64')
               sCmd(kodenya, jri)
               fakeitem("Done!")
               } else {
               fakeitem('Reply Stickernya')
               }
               break
            case 'delcmd':
               if (!isOwner) return fakeitem(mess.only.ownerB)
               if (!isQuotedSticker) return fakeitem(`Penggunaan : ${prefix}${command} tagsticker`)
               var kodenya = caa.message.extendedTextMessage.contextInfo.quotedMessage.stickerMessage.fileSha256.toString('base64')
...
// premium user
            case 'play2':
               if (!isPrem) return fakeitem(mess.only.premium)
				   if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fkatalog(`Contoh: ${prefix + command} Melukis Senja`)
               query = args.join(" ")
            ...
            case 'play':
               if (!isPrem) return fakeitem(mess.only.premium)
				   if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return await fkatalog(`Example: ${prefix + command} melukis senja`)
               query = args.join(" ")
            ...
            case 'ytmp3':
               if (!isPrem) return fakeitem(mess.only.premium) 
				   if (!isUser) return replyca(mess.only.userB)
			    	if (args.length < 1) return fkatalog(`Urlnya mana kak?`)
               fakeitem(mess.wait)
               play = body.slice(7)
            ...
            case 'ytmp4':
               if (!isPrem) return fakeitem(mess.only.premium) 
				   if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fkatalog(`Example: ${prefix + command} https://www.youtube.com/`)
               ini_link = args[0]
            ...
            case 'smule':
	            if (!isPrem) return fakeitem(mess.only.premium)
			     	if (!isUser) return replyca(mess.only.userB)
					if (args.length < 1) return fkatalog('Urlnya mana gan?')
            ...
            case 'joox':
               if (!isPrem) return fakeitem(mess.only.premium)
			     	if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fkatalog(`Example: ${prefix + command} Melukis Senja`)
               query = args.join(" ")
            ...
            case 'tiktok':
               if (!isPrem) return fakeitem(mess.only.premium)
			     	if (!isUser) return replyca(mess.only.userB)
               if (args.length == 0) return fkatalog(`Example: ${prefix + command} https://vt.tiktok.com/`)
               ini_url = args[0]
...
asu = args.join(' ')
           ...
           break
             case 'pinky3':
					if (!isOwner) return fakeitem(mess.only.ownerB)
					if (args.length < 1) return fkatalog('Jumlahnya?')
