...
「 *PINKY BOT* 」`
          nuy.sendMessage(from, allmenu, MessageType.text, {quoted: ftroli, contextInfo: {forwardingScore: 99999, isForwarded: true}, externalAdReply: {"title": name, "body": ator, "previewType": "NONE", "thumbnailUrl": "https://wa.me/message/4CFWJARLRISPA1", "thumbnail": fs.readFileSync('pinky.jpg')}})
          break
          case 'grupmenu':
                if (isBanned) return fakeitem(mess.only.benned)
                if (!isUser) return fakeitem(mess.only.userB)
